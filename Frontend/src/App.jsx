...
const AICustomerCommunication = lazy(() => import("./pages/AICustomerCommunication"));
const AISalesRecommendations = lazy(() => import("./pages/AISalesRecommendations"));
      ...
      <Suspense fallback={<Loader />}>
        <Routes>
          ...
          >
            ...
            <Route path="ai/seo-tool" element={<AISEOTool />} />
