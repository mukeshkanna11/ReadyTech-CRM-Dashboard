...
//         <main className="p-6">
//           <Outlet /> {/* ✅ ROUTED PAGE RENDERS HERE */}
//         </main>
//       </div>
//     </div>
//   );
...
//         <SideLink to="/dashboard" icon={<LayoutDashboard size={18} />} label="Dashboard" open={open} />
//         <SideLink to="/users" icon={<Users size={18} />} label="Users" open={open} />
//         <SideLink to="/clients" icon={<UserCheck size={18} />} label="Clients" open={open} />
//         <SideLink to="/products" icon={<Package size={18} />} label="Products" open={open} />
//         <SideLink to="/leads" icon={<BarChart3 size={18} />} label="Leads" open={open} />
//         <SideLink to="/auditlogs" icon={<Shield size={18} />} label="Audit Logs" open={open} />
//       </nav>

//       <div className="p-3 border-t border-slate-700">
//         <SideLink to="/settings" icon={<Settings size={18} />} label="Settings" open={open} />
//         <button
